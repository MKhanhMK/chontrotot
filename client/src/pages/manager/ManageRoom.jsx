...
const ManageRoom = () => {
  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="mb-4">
        <label htmlFor="status-filter">Lọc theo trạng thái phòng:</label>
        <select
          id="status-filter"
      ...
      <table className="max-w-full w-full overflow-x-auto">
        ...
        <tbody>
          {rooms?.rows
            ?.filter((el) =>
              selectedStatus ? el.position === selectedStatus : true
            )
            .map((el) => (
              <tr key={el.id}>
                ...
                <td
                  className={twMerge(
                    clsx(
                      ...
                      el.position === "Đã thuê" && "text-green-600 bg-green-100",
                      el.position === "Còn trống" && "text-blue-600 bg-blue-100"
                    )
                  )}
                >
                  {el.position}
